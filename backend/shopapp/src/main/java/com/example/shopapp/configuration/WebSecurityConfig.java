    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(requests -> {
                    ...
                    .requestMatchers(HttpMethod.GET, String.format("%s/products/**", apiPrefix))
                            .permitAll()
                    .requestMatchers(HttpMethod.GET, String.format("%s/products/images/*", apiPrefix))
                            .permitAll()
                    ...
                    .requestMatchers(HttpMethod.POST, String.format("%s/orders_details/**", apiPrefix))
                            .hasRole("USER")
                    .requestMatchers(HttpMethod.GET, String.format("%s/orders_details/**", apiPrefix))
                            .hasAnyRole("USER", "ADMIN")
                    .requestMatchers(HttpMethod.PUT, String.format("%s/orders_details/**", apiPrefix))
                            .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.DELETE, String.format("%s/orders_details/**", apiPrefix))
                            .hasRole("ADMIN")
